...
function setupCurrentStats(data) {
    const feelsLikeIcon = document.querySelector('.icon.feels-like');
    const humidityIcon = document.querySelector('.icon.humidity');
    const rainChanceIcon = document.querySelector('.icon.rain-chance');
    const windSpeedIcon = document.querySelector('.icon.wind-speed');
    ...
    rainChance.textContent = data.current.rainChance + '%';
...
function setupForecast(data) {
    ...
    for (let day in days) {
        ...
        date.textContent = data.forecast[days[day]].date;
        maxtemp.textContent = data.forecast[days[day]].maxtemp + '°C';
        mintemp.textContent = data.forecast[days[day]].mintemp + '°C';
        weatherIcon.innerHTML = getIcon(data.forecast[days[day]].icon);
